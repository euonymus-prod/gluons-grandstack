...
class EditQuarkFormBase extends React.Component {
  ...
  render() {
    ...
    const variables = {
      id: this.props.match.params.quark_id
    };
    return (
...
const EditQuarkForm = withRouter(
  withFirebase(withAuthUser(withLastLocation(EditQuarkFormBase)))
);
